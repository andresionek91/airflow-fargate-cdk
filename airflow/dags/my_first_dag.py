...
t1 = PythonOperator(task_id="task_1", dag=dag, python_callable=task_1)

t2 = PythonOperator(task_id="task_2", dag=dag, python_callable=task_2)

t3 = PythonOperator(task_id="task_3", dag=dag, python_callable=task_3)
